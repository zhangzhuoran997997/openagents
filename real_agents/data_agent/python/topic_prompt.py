TOPIC_REF_CODE = """Here are some examples of generating Py-Echarts Code based on the given table(s). Please generate new one based on the data and question human asks you, import the neccessary libraries and make sure the code is correct.
...
# MUST follow reference_code, and only use Pie or Bar function from pyecharts to show topic count distribution.\"\"\"
